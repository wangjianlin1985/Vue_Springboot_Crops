<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收购商名称" prop="shougoushangmingcheng">
          <el-input v-model="ruleForm.shougoushangmingcheng" 
              placeholder="收购商名称" clearable  :readonly="ro.shougoushangmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收购商名称" prop="shougoushangmingcheng">
              <el-input v-model="ruleForm.shougoushangmingcheng" 
                placeholder="收购商名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收购价格" prop="shougoujiage">
          <el-input v-model="ruleForm.shougoujiage" 
              placeholder="收购价格" clearable  :readonly="ro.shougoujiage"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收购价格" prop="shougoujiage">
              <el-input v-model="ruleForm.shougoujiage" 
                placeholder="收购价格" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	crazilynum : false,
      ...
      rules: {
          shougoushangmingcheng: [
                { required: true, message: '收购商名称不能为空', trigger: 'blur' },
          ],
          fengmian: [
          ],
          jingyingfanwei: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='shougoushangmingcheng'){
            this.ruleForm.shougoushangmingcheng = obj[o];
	    this.ro.shougoushangmingcheng = true;
            continue;
          }
          if(o=='fengmian'){
	    ...
	    this.ro.nongzuowumingcheng = true;
          ...
          if(o=='shougoujiage'){
            this.ruleForm.shougoujiage = obj[o];
	    this.ro.shougoujiage = true;
            continue;
          }
          if(o=='thumbsupnum'){
    ...
    info(id) {
      this.$http({
        url: `nongzuowushougoushang/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `nongzuowushougoushang/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.nongzuowushougoushangCrossAddOrUpdateFlag = false;
						 this.parent.search();
