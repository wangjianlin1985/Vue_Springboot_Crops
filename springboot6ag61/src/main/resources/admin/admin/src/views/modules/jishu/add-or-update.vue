<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="主要病虫害" prop="zhuyaobingchonghai">
          <el-input v-model="ruleForm.zhuyaobingchonghai" 
              placeholder="主要病虫害" clearable  :readonly="ro.zhuyaobingchonghai"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="主要病虫害" prop="zhuyaobingchonghai">
              <el-input v-model="ruleForm.zhuyaobingchonghai" 
                placeholder="主要病虫害" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="防治方法" prop="fangzhifangfa">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.fangzhifangfa" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fangzhifangfa" label="防治方法" prop="fangzhifangfa">
                    <span v-html="ruleForm.fangzhifangfa"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='zhuyaobingchonghai'){
            this.ruleForm.zhuyaobingchonghai = obj[o];
	    this.ro.zhuyaobingchonghai = true;
            continue;
          }
          if(o=='fangzhifangfa'){
            this.ruleForm.fangzhifangfa = obj[o];
	    this.ro.fangzhifangfa = true;
            continue;
          }
	...
	this.ruleForm.fangzhifangfa = this.ruleForm.fangzhifangfa.replace(reg,'../../../springboot6ag61/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
