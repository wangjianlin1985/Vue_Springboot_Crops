<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="土壤湿度要求" prop="turangshiduyaoqiu">
          <el-input v-model="ruleForm.turangshiduyaoqiu" 
              placeholder="土壤湿度要求" clearable  :readonly="ro.turangshiduyaoqiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="土壤湿度要求" prop="turangshiduyaoqiu">
              <el-input v-model="ruleForm.turangshiduyaoqiu" 
                placeholder="土壤湿度要求" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="技术员账号" prop="jishuyuanzhanghao">
              <el-input v-model="ruleForm.jishuyuanzhanghao" 
                placeholder="技术员账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="技术员姓名" prop="jishuyuanxingming">
              <el-input v-model="ruleForm.jishuyuanxingming" 
                placeholder="技术员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="天气要求" prop="tianqiyaoqiu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.tianqiyaoqiu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tianqiyaoqiu" label="天气要求" prop="tianqiyaoqiu">
                    <span v-html="ruleForm.tianqiyaoqiu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='turangshiduyaoqiu'){
            this.ruleForm.turangshiduyaoqiu = obj[o];
	    this.ro.turangshiduyaoqiu = true;
            continue;
          }
          if(o=='tianqiyaoqiu'){
            this.ruleForm.tianqiyaoqiu = obj[o];
	    this.ro.tianqiyaoqiu = true;
            continue;
          }
          if(o=='zhuyishixiang'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.jishuyuanzhanghao!=''&&json.jishuyuanzhanghao){
                this.ruleForm.jishuyuanzhanghao = json.jishuyuanzhanghao
	    		this.ro.jishuyuanzhanghao = true;
		}
		if(json.jishuyuanxingming!=''&&json.jishuyuanxingming){
	...
	this.ruleForm.tianqiyaoqiu = this.ruleForm.tianqiyaoqiu.replace(reg,'../../../springboot6ag61/upload');
	this.ruleForm.zhuyishixiang = this.ruleForm.zhuyishixiang.replace(reg,'../../../springboot6ag61/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuanbo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuanboCrossAddOrUpdateFlag = false;
						 this.parent.search();
